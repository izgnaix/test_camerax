...
namespace {
    ...
    public:
        ...
        CheckGlErrorOnExit(const CheckGlErrorOnExit &) = default;
...
Java_com_example_camerax_OpenGLRenderer_initContext(JNIEnv *env, jclass clazz) {
...
Java_com_example_camerax_OpenGLRenderer_setWindowSurface(JNIEnv *env, jclass clazz,
                                                         jlong context, jobject jsurface) {
...
Java_com_example_camerax_OpenGLRenderer_getTexName(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_camerax_OpenGLRenderer_renderTexture(JNIEnv *env, jclass clazz,
                                                      jlong context, jlong timestamp_ns,
...
Java_com_example_camerax_OpenGLRenderer_closeContext(JNIEnv *env, jclass clazz,
                                                     jlong context) {
    auto *nativeContext = reinterpret_cast<NativeContext *>(context);
